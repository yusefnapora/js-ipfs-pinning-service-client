...
export default class PinsApi {
    ...
    */
     ...
     */
    pinsGet(opts) {
      return this.pinsGetWithHttpInfo(opts)
     ...
     */
    pinsPost(pin) {
      return this.pinsPostWithHttpInfo(pin)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    pinsRequestidDelete(requestid) {
      return this.pinsRequestidDeleteWithHttpInfo(requestid)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PinStatus} and HTTP response
     */
    pinsRequestidGetWithHttpInfo(requestid) {
      let postBody = null;
      // verify the required parameter 'requestid' is set
      if (requestid === undefined || requestid === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PinStatus}
     */
    pinsRequestidGet(requestid) {
      return this.pinsRequestidGetWithHttpInfo(requestid)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PinStatus} and HTTP response
     */
    pinsRequestidPostWithHttpInfo(requestid, pin) {
      let postBody = pin;
      // verify the required parameter 'requestid' is set
      if (requestid === undefined || requestid === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PinStatus}
     */
    pinsRequestidPost(requestid, pin) {
      return this.pinsRequestidPostWithHttpInfo(requestid, pin)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
