...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IpfsPinningServiceApi.PinsApi();
  });
  ...
  describe('PinsApi', function() {
    ...
    describe('pinsPost', function() {
      it('should call pinsPost successfully', function(done) {
        //uncomment below and update the code to test pinsPost
        //instance.pinsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pinsRequestidDelete', function() {
      it('should call pinsRequestidDelete successfully', function(done) {
        //uncomment below and update the code to test pinsRequestidDelete
        //instance.pinsRequestidDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pinsRequestidGet', function() {
      it('should call pinsRequestidGet successfully', function(done) {
        //uncomment below and update the code to test pinsRequestidGet
        //instance.pinsRequestidGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pinsRequestidPost', function() {
      it('should call pinsRequestidPost successfully', function(done) {
        //uncomment below and update the code to test pinsRequestidPost
        //instance.pinsRequestidPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
