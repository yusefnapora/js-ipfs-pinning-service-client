...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IpfsPinningServiceApi.PinResults();
  });
  ...
  describe('PinResults', function() {
    it('should create an instance of PinResults', function() {
      // uncomment below and update the code to test PinResults
      //var instane = new IpfsPinningServiceApi.PinResults();
      //expect(instance).to.be.a(IpfsPinningServiceApi.PinResults);
    });

    it('should have the property count (base name: "count")', function() {
      // uncomment below and update the code to test the property count
      //var instance = new IpfsPinningServiceApi.PinResults();
