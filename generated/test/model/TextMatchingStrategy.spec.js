...
(function(root, factory) {
  ...
  describe('TextMatchingStrategy', function() {
    it('should create an instance of TextMatchingStrategy', function() {
      // uncomment below and update the code to test TextMatchingStrategy
      //var instane = new IpfsPinningServiceApi.TextMatchingStrategy();
      //expect(instance).to.be.a(IpfsPinningServiceApi.TextMatchingStrategy);
    });
