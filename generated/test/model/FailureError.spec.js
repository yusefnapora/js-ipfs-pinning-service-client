...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IpfsPinningServiceApi.FailureError();
  });
  ...
  describe('FailureError', function() {
    it('should create an instance of FailureError', function() {
      ...
      //var instane = new IpfsPinningServiceApi.FailureError();
      //expect(instance).to.be.a(IpfsPinningServiceApi.FailureError);
    });

    it('should have the property reason (base name: "reason")', function() {
      // uncomment below and update the code to test the property reason
      //var instance = new IpfsPinningServiceApi.FailureError();
