...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IpfsPinningServiceApi.Pin();
  });
  ...
  describe('Pin', function() {
    it('should create an instance of Pin', function() {
      ...
      //var instane = new IpfsPinningServiceApi.Pin();
      //expect(instance).to.be.a(IpfsPinningServiceApi.Pin);
    });

    it('should have the property cid (base name: "cid")', function() {
      // uncomment below and update the code to test the property cid
      //var instance = new IpfsPinningServiceApi.Pin();
