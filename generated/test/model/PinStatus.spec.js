...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IpfsPinningServiceApi.PinStatus();
  });
  ...
  describe('PinStatus', function() {
    it('should create an instance of PinStatus', function() {
      // uncomment below and update the code to test PinStatus
      //var instane = new IpfsPinningServiceApi.PinStatus();
      //expect(instance).to.be.a(IpfsPinningServiceApi.PinStatus);
    });

    it('should have the property requestid (base name: "requestid")', function() {
      // uncomment below and update the code to test the property requestid
      //var instance = new IpfsPinningServiceApi.PinStatus();
